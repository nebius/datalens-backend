...
class FileUploaderTaskContext(BaseContext):
    ...
    def get_service_registry(self, rci: Optional[RequestContextInfo] = None) -> ServicesRegistry:
        ...
        return create_sr_factory_from_env_vars(
            self.settings.CONNECTORS,  # type: ignore  # 2024-02-01 # TODO: Argument 1 to "create_sr_factory_from_env_vars" has incompatible type "FileUploaderConnectorsSettings | None"; expected "FileUploaderConnectorsSettings"  [arg-type]
