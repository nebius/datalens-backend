...
def create_sr_factory_from_env_vars(
    ...
    return DefaultSRFactory(
        ...
        connectors_settings=connectors_settings,  # type: ignore  # 2024-02-01 # TODO: Argument "connectors_settings" to "DefaultSRFactory" has incompatible type "dict[ConnectionType, FileS3ConnectorSettings | None]"; expected "dict[ConnectionType, ConnectorSettingsBase]"  [arg-type]
        ca_data=ca_data,
    )
