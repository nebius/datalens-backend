...
class CHYTApiBackendDefinition(ClickHouseApiBackendDefinition):
    core_backend_definition = CHYTCoreBackendDefinition  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "type[CHYTCoreBackendDefinition]", base class "ClickHouseApiBackendDefinition" defined the type as "type[ClickHouseCoreBackendDefinition]")  [assignment]
