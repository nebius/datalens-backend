...
class BaseConnectionCHYT(  # type: ignore  # 2024-01-22 # TODO: Definition of "us_manager" in base class "USEntry" is incompatible with definition in base class "ConnectionHardcodedDataMixin"  [misc]
    SubselectMixin,
    ExecutorBasedMixin,
    ConnectionBase,
