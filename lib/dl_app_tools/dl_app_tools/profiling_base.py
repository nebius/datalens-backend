    ...
    def __exit__(self, exc_type: Type[Exception], exc_val: Exception, exc_tb: TTraceback) -> None:
        try:
            ...
            if exc_type is None:
                ...
                span.set_tag(opentracing.span.tags.ERROR, True)  # type: ignore  # 2024-01-22 # TODO: Module has no attribute "tags"  [attr-defined]
...
def generic_profiler(
    stage: str,
    extra_data: dict = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "extra_data" (default has type "None", argument has type "dict[Any, Any]")  [assignment]
    logger: logging.Logger = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "logger" (default has type "None", argument has type "Logger")  [assignment]
    ...
    def generic_profiler_wrap(func: _GP_FUNC_T) -> _GP_FUNC_T:
        ...
        def generic_profiler_wrapper(*args: Any, **kwargs: Any) -> _GP_FUNC_RET_TV:  # type: ignore  # 2024-01-22 # TODO: A function returning TypeVar should receive at least one argument containing the same TypeVar  [type-var]
...
_GPA_CORO_TV = TypeVar("_GPA_CORO_TV", bound=Callable[..., Awaitable[_GPA_CORO_RET_TV]])  # type: ignore  # 2024-01-22 # TODO: Type variable "dl_app_tools.profiling_base._GPA_CORO_RET_TV" is unbound  [valid-type]


def generic_profiler_async(
    stage: str, extra_data: dict = None, logger: logging.Logger = None  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "extra_data" (default has type "None", argument has type "dict[Any, Any]")  [assignment]
