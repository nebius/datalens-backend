...
def get_test_container_hostport(
    ...
    if not file_path and fallback_port is not None:
        ...
        try:
            with open(file_path) as dcyml:  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "open" has incompatible type "str | None"; expected "int | str | bytes | PathLike[str] | PathLike[bytes]"  [arg-type]
