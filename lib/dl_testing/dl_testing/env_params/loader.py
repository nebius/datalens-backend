...
class EnvParamGetterLoader:
    ...
    def get_getter(self, name: str) -> EnvParamGetter:  # type: ignore  # 2024-01-22 # TODO: Missing return statement  [return]
        try:
    ...
    def _resolve_setting_item(self, setting: dict, requirement_getter: EnvParamGetter) -> Optional[str]:  # type: ignore  # 2024-01-22 # TODO: Missing return statement  [return]
    ...
    def initialize(self, getter_config_list: Sequence[Mapping], requirement_getter: EnvParamGetter) -> None:
        for getter_config in getter_config_list:
            ...
            for setting_name, raw_setting in raw_getter_settings.items():
                ...
                resolved_getter_settings[setting_name] = setting_value  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "str | None", target has type "str")  [assignment]
