    ...
    async def run(self) -> TaskResult:
        ...
        try:
            ...
            for src in dfile.sources:
                sources_to_update_by_sheet_id[src.user_source_dsrc_properties.sheet_id].append(src)  # type: ignore  # 2024-01-22 # TODO: Item "UserSourceDataSourceProperties" of "UserSourceDataSourceProperties | None" has no attribute "sheet_id"  [union-attr]
            ...
            await connection_error_tracker.finalize(self.meta.exec_mode, self.meta.connection_id)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "finalize" of "FileConnectionDataSourceErrorTracker" has incompatible type "TaskExecutionMode | None"; expected "TaskExecutionMode"  [arg-type]
            await dfile.save()
            ...
            parse_file_task = task_interface.ParseFileTask(
                ...
                exec_mode=self.meta.exec_mode,  # type: ignore  # 2024-01-22 # TODO: Argument "exec_mode" to "ParseFileTask" has incompatible type "TaskExecutionMode | None"; expected "TaskExecutionMode"  [arg-type]
            )
