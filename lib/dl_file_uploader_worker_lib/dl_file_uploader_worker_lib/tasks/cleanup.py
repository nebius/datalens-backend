                            ...
                            async with usm.locked_entry_cm(
                                ...
                                for source in conn.data.sources:
                                    ...
                                    if source.s3_filename:
                                        ...
                                        old_s3_filename = "_".join([old_tenant_id, uuid, source.s3_filename_suffix])  # type: ignore  # 2024-01-22 # TODO: List item 2 has incompatible type "str | None"; expected "str"  [list-item]
