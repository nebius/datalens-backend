    ...
    def extract(self) -> QueryElementExtract:
        return QueryElementExtract(
            values=(
                ...
                self.formula_data_type_params.as_primitive() if self.formula_data_type is not None else None,  # type: ignore  # 2024-01-22 # TODO: Item "None" of "DataTypeParams | None" has no attribute "as_primitive"  [union-attr]
            )
        )
