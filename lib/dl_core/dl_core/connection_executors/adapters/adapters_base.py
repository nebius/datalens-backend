...
class SyncDirectDBAdapter(CommonBaseDirectAdapter[_TARGET_DTO_TV], metaclass=abc.ABCMeta):
    ...
    @_sync_db_version_action.default  # type: ignore  # 2024-01-22 # TODO: "SyncDBVersionAdapterAction" has no attribute "default"  [attr-defined]
    @final
    def __make_default_sync_db_version_action(self) -> SyncDBVersionAdapterAction:
        return self._make_sync_db_version_action()

    @_sync_schema_names_action.default  # type: ignore  # 2024-01-22 # TODO: "SyncSchemaNamesAdapterAction" has no attribute "default"  [attr-defined]
    @final
    def __make_sync_schema_names_action(self) -> SyncSchemaNamesAdapterAction:
        return self._make_sync_schema_names_action()

    @_sync_table_names_action.default  # type: ignore  # 2024-01-22 # TODO: "SyncTableNamesAdapterAction" has no attribute "default"  [attr-defined]
    @final
    ...
    @_sync_table_info_action.default  # type: ignore  # 2024-01-22 # TODO: Name "__make_sync_test_action" already defined on line 102  [no-redef]
    @final
    def __make_sync_test_action(self) -> SyncTableInfoAdapterAction:
        return self._make_sync_table_info_action()

    @_sync_table_exists_action.default  # type: ignore  # 2024-01-22 # TODO: "SyncTableExistsAdapterAction" has no attribute "default"  [attr-defined]
    @final
