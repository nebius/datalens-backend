...
class OperationProcessorAsyncBase(abc.ABC):
    ...
    def pre_run(self, ctx: OpExecutionContext) -> None:  # type: ignore  # 2024-01-22 # TODO: Name "pre_run" already defined on line 101  [no-redef]
        self._save_start_exec_reporting_record(ctx=ctx)

    def post_run(self, ctx: OpExecutionContext, exec_exception: Optional[Exception]) -> None:  # type: ignore  # 2024-01-22 # TODO: Name "post_run" already defined on line 104  [no-redef]
