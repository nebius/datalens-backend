...
class CompengOptionsBuilder(DatasetOptionsBuilder):  # TODO: Move to compeng package
    ...
    def get_cache_options(
        ...
        ttl_info = self.get_cache_ttl_info(data_source_list=joint_dsrc_info.data_source_list)  # type: ignore  # 2024-01-22 # TODO: Argument "data_source_list" to "get_cache_ttl_info" of "CacheOptionsBuilderBase" has incompatible type "tuple[DataSource, ...] | None"; expected "Collection[DataSource]"  [arg-type]
    ...
    def get_data_key(
        ...
        *,
        ...
        compiled_query = self.get_query_str_for_cache(
            ...
            dialect=from_info.query_compiler.dialect,  # type: ignore  # 2024-01-22 # TODO: Item "None" of "PreparedFromInfo | None" has no attribute "query_compiler"  [union-attr]
        )
    ...
    def get_data_key(
        ...
        *,
        ...
        data_key: Optional[LocalKeyRepresentation] = self.make_data_select_cache_key(
            base_key=base_key,
            from_info=from_info,  # type: ignore  # 2024-01-22 # TODO: Argument "from_info" to "make_data_select_cache_key" of "SelectorCacheOptionsBuilder" has incompatible type "PreparedFromInfo | None"; expected "PreparedFromInfo"  [arg-type]
...
class DashSQLCacheOptionsBuilder(CacheOptionsBuilderBase):
    ...
    def get_cache_options(
        ...
        if not cache_enabled:
            local_key_rep = None  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "None", variable has type "LocalKeyRepresentation")  [assignment]
