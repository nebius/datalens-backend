    ...
    def _create_data_processor(
        ...
        **kwargs: Any,
        ...
        if allow_cache_usage:
            processor = CacheOperationProcessor(  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "CacheOperationProcessor", variable has type "SourceDbOperationProcessor")  [assignment]
                service_registry=self.services_registry,
                dataset=dataset,
