...
class USBadRequestException(USReqException):
    ...
    def message(self) -> str:
        try:
            if self.orig_exc and isinstance(self.orig_exc.response, requests.Response):  # type: ignore  # 2024-01-22 # TODO: "Exception" has no attribute "response"  [attr-defined]
                return self.orig_exc.response.json()["message"]  # type: ignore  # 2024-01-22 # TODO: "Exception" has no attribute "response"  [attr-defined]
