...
class BaseSQLDataSource(DataSource):
    ...
    def get_dialect(self) -> DefaultDialect:
        return self.connection.get_dialect()  # type: ignore  # 2024-01-22 # TODO: "ConnectionBase" has no attribute "get_dialect"  [attr-defined]

    def quote(self, value) -> sa.sql.quoted_name:  # type: ignore  # TODO: fix  # subclass of str
        return self.connection.quote(value)  # type: ignore  # 2024-01-22 # TODO: "ConnectionBase" has no attribute "quote"  [attr-defined]
...
class SubselectDataSource(BaseSQLDataSource):
    ...
    def get_table_definition(self) -> TableDefinition:
        ...
        return SATextTableDefinition(text=subselect)  # type: ignore  # 2024-01-22 # TODO: Argument "text" to "SATextTableDefinition" has incompatible type "ClauseElement"; expected "TextClause"  [arg-type]
