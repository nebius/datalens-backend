...
def is_forkable_dialect(dialect: DialectCombo):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    return _IS_FORKABLE_DIALECT.get(dialect.common_name, _IS_FORKABLE_DEFAULT)


def register_forkable_dialect_name(dialect_name: DialectName, is_forkable: bool):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    try:
