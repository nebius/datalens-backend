...
class AppSettings:
    ...
    FORMULA_SUPPORTED_FUNC_TAGS: tuple[str] = s_attrib(  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "Attribute[Any]", variable has type "tuple[str]")  [assignment]
