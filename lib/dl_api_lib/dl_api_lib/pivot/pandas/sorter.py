...
class PdPivotSorterBase(PivotSorter):
    ...
    def _single_axis_sort(self, axis: SortAxis, directions: Sequence[OrderDirection]) -> None:
        ...
        self._get_pd_obj().sort_index(  # type: ignore  # 2024-01-22 # TODO: No overload variant of "sort_index" of "DataFrame" matches argument types "int", "bool | list[bool]", "bool", "Callable[[Index], Index]"  [call-overload]
    ...
    def _sort_by_measure(self, axis: SortAxis, sorting_piid: int, settings: PivotMeasureSortingSettings) -> None:
        ...
        if self._has_total(self._complementary_axis(axis)):
            ...
            sorting_key = sorting_key[order]  # type: ignore  # 2024-01-22 # TODO: Invalid index type "list[int]" for "Series[Any]"; expected type "list[str] | Index | Series[Any] | slice | Series[bool] | ndarray[Any, dtype[bool_]] | list[bool] | tuple[Any | slice, ...]"  [index]
