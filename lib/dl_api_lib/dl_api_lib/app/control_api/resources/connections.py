...
def _handle_conn_test_exc(exception: Exception):  # type: ignore  # 2024-02-01 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class ConnectionParamsTester(BIResource):
    ...
    def post(self):  # type: ignore  # 2024-02-01 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class ConnectionTester(BIResource):
    @schematic_request(ns=ns)
    def post(self, connection_id):  # type: ignore  # 2024-02-01 # TODO: Function is missing a type annotation  [no-untyped-def]
...
class ConnectionItem(BIResource):
    ...
    def get(self, connection_id):  # type: ignore  # 2024-02-01 # TODO: Function is missing a type annotation  [no-untyped-def]
    ...
    @schematic_request(ns=ns)
    def put(self, connection_id):  # type: ignore  # 2024-02-01 # TODO: Function is missing a type annotation  [no-untyped-def]
        us_manager = self.get_us_manager()

        with us_manager.get_locked_entry_cm(ConnectionBase, connection_id) as conn:  # type: ignore  # 2024-02-01 # TODO: Need type annotation for "conn"  [var-annotated]
            need_permission_on_entry(conn, USPermissionKind.edit)
...
def _dump_source_templates(tpls) -> dict:  # type: ignore  # 2024-02-01 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    if tpls is None:
        return None  # type: ignore  # 2024-02-01 # TODO: Incompatible return value type (got "None", expected "dict[Any, Any]")  [return-value]
    return [dict(tpl._asdict(), parameter_hash=tpl.get_param_hash()) for tpl in tpls]  # type: ignore  # 2024-02-01 # TODO: Incompatible return value type (got "list[dict[str, Any]]", expected "dict[Any, Any]")  [return-value]
...
class ConnectionInfoSources(BIResource):
    ...
    def get(self, connection_id, query):  # type: ignore  # 2024-02-01 # TODO: Function is missing a type annotation  [no-untyped-def]
        connection = self.get_us_manager().get_by_id(connection_id, expected_type=ConnectionBase)
...
class ConnectionInfoSourceSchema(BIResource):
    ...
    def post(self, connection_id: str, body: dict):  # type: ignore  # 2024-02-01 # TODO: Function is missing a return type annotation  [no-untyped-def]
        connection = self.get_us_manager().get_by_id(connection_id, expected_type=ConnectionBase)
