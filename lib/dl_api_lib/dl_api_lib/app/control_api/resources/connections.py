...
class ConnectionParamsTester(BIResource):
    ...
    def post(self):  # type: ignore  # TODO: fix
        ...
        body_json = dict(request.json)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "dict" has incompatible type "Any | None"; expected "SupportsKeysAndGetItem[Any, Any]"  [arg-type]
...
class ConnectionTester(BIResource):
    ...
    def post(self, connection_id):  # type: ignore  # TODO: fix
        ...
        schema_cls = GenericConnectionSchema().get_edit_schema_cls(conn)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "get_edit_schema_cls" of "GenericConnectionSchema" has incompatible type "USEntry"; expected "ConnectionBase"  [arg-type]
        ...
        conn.validate_new_data_sync(services_registry=service_registry, changes=changes, original_version=conn_orig)  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "validate_new_data_sync"  [attr-defined]

        try:
            conn.test(conn_executor_factory=service_registry.get_conn_executor_factory().get_sync_conn_executor)  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "test"  [attr-defined]
        except NotImplementedError as err:
            raise exc.UnsupportedForEntityType(f"Connector {conn.conn_type.name} does not support testing") from err  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "conn_type"  [attr-defined]
...
class ConnectionsList(BIResource):
    ...
    def post(self):  # type: ignore  # TODO: fix
        ...
        conn_type_is_available = conn_availability.check_connector_is_available(ct[request.json.get("type")])  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Any | None" has no attribute "get"  [union-attr]
...
class ConnectionItem(BIResource):
    ...
    def get(self, connection_id):  # type: ignore  # TODO: fix
        ...
        result.update(options=ConnectionOptionsSchema().dump(self._make_options_data(conn)))  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "_make_options_data" of "ConnectionItem" has incompatible type "USEntry"; expected "ConnectionBase"  [arg-type]
        return result
    ...
    def put(self, connection_id):  # type: ignore  # TODO: fix
        ...
        with us_manager.get_locked_entry_cm(ConnectionBase, connection_id) as conn:  # type: ignore  # TODO: fix
            ...
            try:
                changes = schema.load(request.json)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "load" of "Schema" has incompatible type "Any | None"; expected "Mapping[str, Any] | Iterable[Mapping[str, Any]]"  [arg-type]
                schema.update_object(conn, changes)
            except MValidationError as e:
                return e.messages, 400
            conn.validate_new_data_sync(  # type: ignore  # 2024-01-22 # TODO: <nothing> has no attribute "validate_new_data_sync"  [attr-defined]
...
class ConnectionInfoMetadataSources(BIResource):
    ...
    def get(self, connection_id):  # type: ignore  # TODO: fix
        ...
        source_template_templates = connection.get_data_source_template_templates(localizer=localizer)  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "get_data_source_template_templates"  [attr-defined]
        ...
        try:
            ...
            source_templates = connection.get_data_source_local_templates()  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "get_data_source_local_templates"  [attr-defined]
...
class ConnectionInfoSources(BIResource):
    ...
    def get(self, connection_id, query):  # type: ignore  # TODO: fix
        ...
        try:
            ...
            source_templates = connection.get_data_source_templates(  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "get_data_source_templates"  [attr-defined]
...
class ConnectionInfoSourceSchema(BIResource):
    ...
    def post(self, connection_id: str, body: dict):  # type: ignore  # TODO: fix
        ...
        def conn_executor_factory_func() -> SyncConnExecutorBase:
            conn_executor = sr.get_conn_executor_factory().get_sync_conn_executor(conn=connection)  # type: ignore  # 2024-01-22 # TODO: Argument "conn" to "get_sync_conn_executor" of "ConnExecutorFactory" has incompatible type "USEntry"; expected "ConnectionBase"  [arg-type]
            return conn_executor

        need_permission_on_entry(connection, USPermissionKind.read)
        if not connection.is_dashsql_allowed:  # type: ignore  # 2024-01-22 # TODO: "USEntry" has no attribute "is_dashsql_allowed"  [attr-defined]
