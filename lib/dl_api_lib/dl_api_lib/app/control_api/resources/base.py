            ...
            attrs = {
                ...
                meth_name: (
                    api_decorators.with_profiler_stats(
                        ...
                        condition_check=_profile_request_check if PROFILE_REQ_PATH_RE else None,  # type: ignore  # 2024-01-22 # TODO: Argument "condition_check" to "with_profiler_stats" has incompatible type "Callable[[VarArg(Any), KwArg(Any)], bool] | None"; expected "Callable[..., Any]"  [arg-type]
                    )(method)
