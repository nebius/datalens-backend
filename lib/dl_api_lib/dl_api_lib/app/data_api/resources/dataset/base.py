...
class DatasetDataBaseView(BaseView):
    ...
    async def resolve_entities(self) -> None:
        ...
        if self.dataset_id is None:
            ...
            try:
                dataset = await us_manager.get_by_id(self.dataset_id, Dataset)  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "USEntry", variable has type "Dataset")  [assignment]
