    ...
    def build_exec_info(self) -> QueryExecutionInfo:
        ...
        for avatar_id in translated_multi_query.get_base_root_from_ids():
            ...
            if connection not in target_connections:
                target_connections.append(connection)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "append" of "list" has incompatible type "ConnectionBase"; expected "ClassicConnectionSQL"  [arg-type]
