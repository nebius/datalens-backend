...
class PostgreSQLCoreConnector(CoreConnector):
    ...
    sa_types = SQLALCHEMY_POSTGRES_TYPES  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "dict[GenericNativeType, function]", base class "CoreConnector" defined the type as "dict[GenericNativeType, Callable[[GenericNativeType], TypeEngine]] | None")  [assignment]
