...
def get_sub_keys(prefix: str, env: SDict):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class ScalarExtractor(SDictExtractor):
    ...
    def _extract(self, s_dict: SDict) -> Any:
        ...
        value = s_dict[self.key]  # type: ignore  # 2024-01-22 # TODO: Invalid index type "str | None" for "Mapping[str, str]"; expected type "str"  [index]
...
class DefaultOnlyExtractor(SDictExtractor):
    def __attrs_post_init__(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class CompositeExtractor(SDictExtractor):
    ...
    def should_ignore(self, s_dict) -> bool:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        ...
        if self.field_enables_flag_extractor.has_field(scoped_s_dict):  # type: ignore  # 2024-01-22 # TODO: Item "None" of "ScalarExtractor | None" has no attribute "has_field"  [union-attr]
            should_read = self.field_enables_flag_extractor.extract(scoped_s_dict)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "ScalarExtractor | None" has no attribute "extract"  [union-attr]
    ...
    def _ensure_no_missing_fields(
        ...
        def handle_field_sub_exc(faulty_field_name: str, exc: ConfigFieldMissing):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class EnvSettingsLoader:
    ...
    def build_default_extractor(
        ...
        env_var_name = meta.name.upper()  # type: ignore  # 2024-01-22 # TODO: Item "None" of "str | None" has no attribute "upper"  [union-attr]
        ...
        simple_type_converters: dict[Type, Callable[[str], Any]] = {
            int: int,
            float: float,
            str: None,  # type: ignore  # 2024-01-22 # TODO: Dict entry 2 has incompatible type "type[str]": "None"; expected "type[Any]": "Callable[[str], Any]"  [dict-item]
    ...
    def unwrap_union(the_type: Type, ignore_none: bool) -> frozenset[Type]:
        if typing.get_origin(the_type) == Union:
            ...
            if ignore_none:
                ...
                unwrapped_types = [argtype for argtype in unwrapped_types if argtype is not type(None)]  # noqa: E721  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "list[Any]", variable has type "tuple[Any, ...]")  [assignment]
    ...
    def is_sub_settings_field(cls, attrib: attr.Attribute) -> bool:
        ...
        possible_types = cls.unwrap_union(the_type, ignore_none=True)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "unwrap_union" of "EnvSettingsLoader" has incompatible type "type[Any] | None"; expected "type[Any]"  [arg-type]
    ...
    def build_composite_extractor(
        ...
        for field_name, field in map_field_name_field.items():
            ...
            if field_s_meta.fallback_cfg_key is not None:
                ...
                field_default = getattr(fallback_cfg, field_s_meta.name, NOT_SET)  # type: ignore  # 2024-01-22 # TODO: Argument 2 to "getattr" has incompatible type "str | None"; expected "str"  [arg-type]
                if (
            ...
            if field_s_meta.name is None:
                child_extractor = DefaultOnlyExtractor(
                    ...
                    expected_type=field.type,  # type: ignore  # 2024-01-22 # TODO: Argument "expected_type" to "DefaultOnlyExtractor" has incompatible type "type[Any] | None"; expected "type[Any]"  [arg-type]
                )
                ...
                child_extractor = cls.build_composite_extractor(
                    settings_type=field.type,  # type: ignore  # 2024-01-22 # TODO: Argument "settings_type" to "build_composite_extractor" of "EnvSettingsLoader" has incompatible type "type[Any] | None"; expected "type[SettingsBase]"  [arg-type]
                    key_prefix=key_prefix + (field_s_meta.name,),
                    default=field_default,
                    json_converter=field_s_meta.json_converter,
                    field_enables_flag_extractor=None  # type: ignore  # 2024-01-22 # TODO: Argument "field_enables_flag_extractor" to "build_composite_extractor" of "EnvSettingsLoader" has incompatible type "ScalarExtractor | DictExtractor | None"; expected "ScalarExtractor | None"  [arg-type]
                ...
                child_extractor = cls.build_default_extractor(
                    name=field_name,
                    field_type=field.type,  # type: ignore  # 2024-01-22 # TODO: Argument "field_type" to "build_default_extractor" of "EnvSettingsLoader" has incompatible type "type[Any] | None"; expected "type[Any]"  [arg-type]
                    meta=field_s_meta,
                    default=field_default,
                )
    ...
    def get_app_cfg_type_field(cls, settings_type: Type[SettingsBase]) -> Optional[attr.Attribute]:
        candidates = [field for field in attr.fields(settings_type) if SMeta.from_attrib(field).is_app_cfg_type]  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "fields" has incompatible type "type[SettingsBase]"; expected "type[AttrsInstance]"  [arg-type]
        if len(candidates) > 1:
    ...
    def get_app_cfg_type_value_from_env(cls, settings_type: Type[SettingsBase], s_dict: SDict) -> Any:
        ...
        extractor = cls.build_default_extractor(
            ...
            field_type=app_cfg_type_field.type,  # type: ignore  # 2024-01-22 # TODO: Argument "field_type" to "build_default_extractor" of "EnvSettingsLoader" has incompatible type "type[Any] | None"; expected "type[Any]"  [arg-type]
            meta=SMeta.from_attrib(app_cfg_type_field),  # type: ignore  # 2024-01-22 # TODO: Argument "meta" to "build_default_extractor" of "EnvSettingsLoader" has incompatible type "SMeta | None"; expected "SMeta"  [arg-type]
            default=NOT_SET,
        )
    ...
    def build_top_level_extractor(
        ...
        return cls.build_composite_extractor(
            settings_type=settings_type,  # type: ignore  # 2024-01-22 # TODO: Argument "settings_type" to "build_composite_extractor" of "EnvSettingsLoader" has incompatible type "type[_SETTINGS_TV]"; expected "type[SettingsBase]"  [arg-type]
    ...
    def load_settings(
        ...
        app_cfg_type = self.get_app_cfg_type_value_from_env(settings_type, effective_s_dict)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "get_app_cfg_type_value_from_env" of "EnvSettingsLoader" has incompatible type "type[_SETTINGS_TV]"; expected "type[SettingsBase]"  [arg-type]
