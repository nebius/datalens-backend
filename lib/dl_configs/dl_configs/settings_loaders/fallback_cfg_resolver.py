...
class ObjectLikeConfig(Mapping):
    ...
    def _get_key(self, key: Any):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    def get(self, key: Any):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    def to_dict(self) -> dict[str, Any]:
        def _get_value_for_dict(v) -> Any:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
...
class YamlFileConfigResolver(FallbackConfigResolver):
    ...
    @classmethod
    def is_config_enabled(cls, s_dict: SDict):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    def resolve(self, s_dict: SDict) -> ObjectLikeConfig:
        ...
        with open(path) as f:  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "open" has incompatible type "str | None"; expected "int | str | bytes | PathLike[str] | PathLike[bytes]"  [arg-type]
