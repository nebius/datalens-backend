...
class SMeta:
    ...
    def to_dict(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
def s_attrib(
    ...
    s_meta = SMeta(
        ...
        fallback_factory=fallback_factory,  # type: ignore  # 2024-01-22 # TODO: Argument "fallback_factory" to "SMeta" has incompatible type "Callable[[Any, Any], Any] | Callable[[Any], Any] | None"; expected "Callable[[Any], Any] | None"  [arg-type]
...
def required(t: Type[_REQUIRED_TV]) -> _REQUIRED_TV:
    ...
    """
    return cast(t, RequiredValue())  # type: ignore  # 2024-01-22 # TODO: Variable "t" is not valid as a type  [valid-type]
