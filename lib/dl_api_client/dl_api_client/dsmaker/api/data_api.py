...
class DataApiV1SerializationAdapter(BaseApiV1SerializationAdapter):
    def make_req_data_get_preview(
        ...
        *,
        dataset: Dataset,
        updates: List[Union[UpdateAction, dict]] = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "updates" (default has type "None", argument has type "list[UpdateAction | dict[Any, Any]]")  [assignment]
        limit: int = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "limit" (default has type "None", argument has type "int")  [assignment]
    ) -> Dict[str, Any]:
...
class SyncHttpDataApiV1(SyncHttpDataApiBase):
    ...
    def get_preview(
        ...
        *,
        ...
        return self.make_response_obj(client_response=response, data=resp_data)  # type: ignore  # 2024-01-22 # TODO: Argument "data" to "make_response_obj" of "DataApiBaseMixin" has incompatible type "dict[Any, Any] | None"; expected "dict[Any, Any]"  [arg-type]
    ...
    def get_result(
        ...
        *,
        ...
        updates: List[Union[UpdateAction, dict]] = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "updates" (default has type "None", argument has type "list[UpdateAction | dict[Any, Any]]")  [assignment]
        limit: int = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "limit" (default has type "None", argument has type "int")  [assignment]
        offset: int = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "offset" (default has type "None", argument has type "int")  [assignment]
        fields: Optional[List[ResultField]] = None,
        group_by: Optional[List[ResultField]] = None,
        order_by: Optional[List[Union[ResultField, OrderedField]]] = None,
        ...
        response = self.get_response_for_dataset_result(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
    ...
    def get_value_range(
        ...
        *,
        ...
        response = self.get_response_for_dataset_value_range(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
    ...
    def get_distinct(
        ...
        *,
        ...
        response = self.get_response_for_dataset_value_distinct(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
...
class DataApiV2SerializationAdapter(BaseApiV1SerializationAdapter):
    ...
    def make_req_data_get_preview(
        ...
        *,
        ...
        data = self.dump_dataset(dataset)
        updates = list(updates or ()) + self.generate_implicit_updates(dataset)  # type: ignore  # 2024-01-22 # TODO: Unsupported operand types for + ("list[UpdateAction | dict[Any, Any]]" and "list[UpdateAction]")  [operator]
        data["updates"] = self.dump_updates(updates)
    ...
    def make_req_data_get_value_range(
        ...
        *,
        ...
        data = self.make_req_data_common(
            dataset=dataset,
            fields=fields,  # type: ignore  # 2024-01-22 # TODO: Argument "fields" to "make_req_data_common" of "DataApiV2SerializationAdapter" has incompatible type "list[RequestLegendItem]"; expected "list[ResultField | RequestLegendItem] | None"  [arg-type]
            filters=filters,
            parameters=parameters,
            blocks=blocks,
            updates=updates,
    ...
    def make_req_data_get_pivot(
        ...
        *,
        ...
        data = self.make_req_data_common(
            ...
            offset=offset,
            fields=fields,
            order_by=order_by,  # type: ignore  # 2024-01-22 # TODO: Argument "order_by" to "make_req_data_common" of "DataApiV2SerializationAdapter" has incompatible type "list[OrderedField] | None"; expected "list[ResultField | OrderedField] | None"  [arg-type]
            filters=filters,
            blocks=blocks,
...
class SyncHttpDataApiV2(SyncHttpDataApiBase):
    ...
    def get_pivot(
        ...
        *,
        ...
        response = self.get_response_for_dataset_pivot(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
...
class AsyncHttpDataApiV2(AsyncHttpDataApiBase):
    ...
    async def get_result(
        ...
        *,
        ...
        response = await self.get_response_for_dataset_result(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
    ...
    async def get_value_range(
        ...
        *,
        ...
        response = await self.get_response_for_dataset_value_range(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
    ...
    async def get_distinct(
        ...
        *,
        ...
        response = await self.get_response_for_dataset_value_distinct(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
    ...
    async def get_pivot(
        ...
        *,
        ...
        response = await self.get_response_for_dataset_pivot(dataset_id=dataset.id, raw_body=data)  # type: ignore  # 2024-01-22 # TODO: Item "None" of "Dataset | None" has no attribute "id"  [union-attr]
        resp_data: Optional[dict] = None
        if not fail_ok:
            assert response.status_code == HTTPStatus.OK, response.json
        if response.status_code == HTTPStatus.OK:
