...
class AsyncHttpApiBase(ApiBase):
    ...
    async def _request(
        ...
        lock_timeout: int = None,  # type: ignore  # 2024-01-22 # TODO: Incompatible default for argument "lock_timeout" (default has type "None", argument has type "int")  [assignment]
    ) -> ClientResponse:
        ...
        while response.status_code == HTTPStatus.LOCKED and lock_timeout and time.monotonic() - started < lock_timeout:
            ...
            response = send_request()  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "Coroutine[Any, Any, ClientResponse]", variable has type "ClientResponse")  [assignment]
