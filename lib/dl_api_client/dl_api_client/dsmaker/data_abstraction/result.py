...
from dl_api_client.dsmaker.data_abstraction.legend import FieldLegend
from dl_api_client.dsmaker.data_abstraction.mapping_base import (
    DataCellMapper1D,
...
class ResultRowSplitter:
    ...
    def split_row_by_measures(self, raw_row: ResultRawDataRow) -> Generator[tuple[DataCellTuple, DataCell], None, None]:
        ...
        for measure_cell, measure_liid in measure_cells_and_liids:
            ...
            yield dim_tuple, DataItem(cell=measure_cell, meta=DataItemMeta(tags=frozenset(tags)))  # type: ignore  # 2024-01-22 # TODO: Incompatible types in "yield" (actual type "tuple[DataCellTuple, DataItem]", expected type "tuple[DataCellTuple, DataCell]")  [misc]
...
class ResultDataAbstraction:
    ...
    def get_1d_mapper(
        ...
        return SimpleDataCellMapper1D(
            cells={
                dim_tuple: cell  # type: ignore  # 2024-01-22 # TODO: Value expression in dictionary comprehension has incompatible type "DataCell"; expected type "DataItem"  [misc]
