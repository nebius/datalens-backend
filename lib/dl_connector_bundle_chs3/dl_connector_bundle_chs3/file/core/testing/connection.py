    ...
    **kwargs: Any,
    ...
    conn = FileS3Connection.create_from_dict(
        data_dict=FileS3Connection.DataModel(
            sources=sources,  # type: ignore  # 2024-01-22 # TODO: Argument "sources" to "DataModel" has incompatible type "list[dl_connector_bundle_chs3.file.core.us_connection.FileS3Connection.FileDataSource]"; expected "list[dl_connector_bundle_chs3.chs3_base.core.us_connection.BaseFileS3Connection.FileDataSource]"  [arg-type]
        ),
        ds_key=conn_name,
