...
def create_s3_native_from_ch_table(
    ...
    s3_tbl_func_for_db = s3_tbl_func(
        ...
        conn_dto=BaseFileS3ConnDTO(
            conn_id=None,
            protocol="http",
            host=db.url.host,  # type: ignore  # 2024-01-22 # TODO: Argument "host" to "BaseFileS3ConnDTO" has incompatible type "str | None"; expected "str"  [arg-type]
            port=db.url.port,  # type: ignore  # 2024-01-22 # TODO: Argument "port" to "BaseFileS3ConnDTO" has incompatible type "int | None"; expected "int"  [arg-type]
            username=db.url.username,  # type: ignore  # 2024-01-22 # TODO: Argument "username" to "BaseFileS3ConnDTO" has incompatible type "str | None"; expected "str"  [arg-type]
            password=db.url.password,  # type: ignore  # 2024-01-22 # TODO: Argument "password" to "BaseFileS3ConnDTO" has incompatible type "object"; expected "str"  [arg-type]
