...
def gsheets_file_s3_settings_fallback(full_cfg: ConnectorsConfigType) -> dict[str, ConnectorSettingsBase]:
    ...
    return dict(
        GSHEETS_V2=FileS3ConnectorSettings(  # type: ignore
            ...
            S3_ENDPOINT=full_cfg.S3_ENDPOINT_URL,  # type: ignore  # 2024-01-22 # TODO: Item "LegacyDefaults" of "ObjectLikeConfig | LegacyDefaults" has no attribute "S3_ENDPOINT_URL"  [union-attr]
            BUCKET=full_cfg.FILE_UPLOADER_S3_PERSISTENT_BUCKET_NAME,  # type: ignore  # 2024-01-22 # TODO: Item "LegacyDefaults" of "ObjectLikeConfig | LegacyDefaults" has no attribute "FILE_UPLOADER_S3_PERSISTENT_BUCKET_NAME"  [union-attr]
        )
    )
