...
class GSheetsFileS3ConnectionLifecycleManager(
    ...
    async def post_exec_async_hook(self) -> None:
        ...
        await fu_client.update_connection_data_internal(
            ...
            sources=sources,  # type: ignore  # 2024-01-22 # TODO: Argument "sources" to "update_connection_data_internal" of "FileUploaderClient" has incompatible type "list[GSheetsFileSourceDesc]"; expected "list[GSheetsFileSourceDesc | YaDocsFileSourceDesc]"  [arg-type]
