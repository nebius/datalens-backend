...
class ParserNotFoundError(Exception):
    ...
    def __str__(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def _ifnone(first, second):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
