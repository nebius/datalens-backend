...
class DataType(Enum):
    ...
    @classmethod
    def get_common_cast_type(cls, *types) -> DataType:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
