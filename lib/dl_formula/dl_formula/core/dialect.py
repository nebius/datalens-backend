...
def register_default_dialect(dialect_name: DialectName, dialect_combo: DialectCombo):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
