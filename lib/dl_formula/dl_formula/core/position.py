...
class PositionConverter:
    ...
    def idx_to_position(self, idx: int):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        start = idx
        end = idx
    ...
    def merge_positions(self, start_position: Position, end_position: Position):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        return Position(
