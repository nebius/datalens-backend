...
class SqlAlchemyTranslator:
    ...
    @staticmethod
    def _coerce_type(ctx: TranslationCtx):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        """
    ...
    def _postprocess_context(self, ctx: TranslationCtx):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
