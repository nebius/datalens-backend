...
class Validator:
    ...
    @contextmanager
    def handle_error(self, checker_cls: Type["Checker"], node: nodes.FormulaItem):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        try:
            yield
...
class ValidatorProxy:
    ...
    @contextmanager
    def handle_error(self, node: nodes.FormulaItem):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
