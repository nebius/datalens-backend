...
class FormulaCliTool:
    ...
    @classmethod
    def parse(cls, text: str, pretty: bool, suppress_errors: bool, pos: Optional[int] = None, with_meta: bool = False):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        if not text:
    ...
    @classmethod
    def split(cls, text: str, diff: bool):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        formula = formula_parser.parse(text)

        chars = []  # type: ignore  # TODO: fix

        def _mark_positions(node, level=0):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
            if len(chars) == level:
    ...
    @staticmethod
    def graph(text: str, render_to: str, view: bool):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        formula = formula_parser.parse(text)
        dot = dl_formula.dot.translate(formula)
        make_graphviz_graph(dot, render_to=render_to, view=view)

    @classmethod
    def translate(  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    @staticmethod
    def list_dialects():  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        print(
            "\n".join(
                [
    ...
    @classmethod
    def goto_func(cls, name: str, show: bool):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    @classmethod
    def run(cls, args):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
        tool = cls()
...
def main():  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    load_formula_lib()
