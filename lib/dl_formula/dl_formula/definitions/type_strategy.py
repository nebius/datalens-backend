...
from dl_formula.translation.type_strategy import (
    TypeParamsStrategy,
    TypeStrategy,
)
...
class Combined(TypeStrategy):
    ...
    def __init__(self, *substrats: TypeStrategy, replace_types=None):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        self._substrats = []
