...
def un_literal(sa_obj: Optional[Literal], value_ctx: Optional[TranslationCtx] = None):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
def is_literal(sa_obj) -> bool:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    try:
        un_literal(sa_obj)
    except ValueError:
        return False
