...
class StrictMarkupCompatibleArgTypes(ArgTypeForAll):
    ...
    def __init__(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
def concat_strings(items, sep=""):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    result = []
    literals_buf = []  # type: ignore  # TODO: fix

    def flush():  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        if literals_buf:
...
def concat(nodes):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def process_markup_child(node):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def markup_node(func_name, *children):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    """
...
def make_variants(func_name):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    return [
        VW(
            D.DUMMY | D.SQLITE,
...
class MarkupTypeStrategy(Fixed):
    ...
    def get_from_args(self, arg_types):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
