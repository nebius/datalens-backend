...
def quote_like(value, escape="\\", chars=("%", "_")):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    for char in (escape,) + tuple(chars):
        value = value.replace(char, escape + char)
    return value


def quote_like_metrica(value):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
