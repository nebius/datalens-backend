...
class CaseBlock(CondBlock):
    ...
    @staticmethod
    def _ifnull(value, data_type: DataType) -> bool:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    ...
    @classmethod
    def translation(cls, *args, replace_nulls: bool = False, as_multiif: bool = False):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        ...
        def _then_else_wrap(expr):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
            if replace_nulls:
