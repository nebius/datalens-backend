...
def _date_datetime_add_yql(value_expr, type_expr, mult_expr, *, const_mult: bool) -> ClauseElement:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
...
def date_add_yql(value_expr, type_expr, mult_expr, *, const_mult: bool) -> ClauseElement:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    expr = _date_datetime_add_yql(value_expr, type_expr, mult_expr, const_mult=const_mult)
    return sa.func.DateTime.MakeDate(expr)


def datetime_add_yql(value_expr, type_expr, mult_expr, *, const_mult: bool) -> ClauseElement:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    expr = _date_datetime_add_yql(value_expr, type_expr, mult_expr, const_mult=const_mult)
...
def ensure_naive_datetime(datetime_ctx):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def ensure_naive_first_arg(func):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    ...
    def _ensured_naive_first_arg(datetime_ctx, *args, **kwargs):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def make_ch_tz_args(date_ctx) -> Tuple[Tuple[Any, ...], Tuple[Any, ...]]:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    """
...
def ch_date_with_tz(date_ctx) -> Tuple[ClauseElement, ...]:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
