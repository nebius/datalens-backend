...
def as_bigint(value):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def _in_fix_null(left, right, stringify_values):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def _not_in_fix_null(left, right, stringify_values):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    new_left, new_right = _prepare_in_args(left, right, stringify_values)
    if len(new_right) == len(right):
        return sa.or_(
...
def _prepare_in_args(left, right, stringify_values: bool):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
