...
class _TextClauseHack(sa.sql.elements.TextClause):
    def __bool__(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
def raw_sql(sql_text):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    """Basically just `sa.text(sql_text)` with hacks"""
    return _TextClauseHack(sql_text)


def make_binary_chain(binary_callable, *args, wrap_as_nodes: bool = True):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    if len(args) == 0:
        return None
...
def quantile_value(quant: float):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    """
...
def ifnotnull(value, expr):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def within_group(clause_el: ClauseElement, *order_by) -> _PatchedWithinGroup:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
