...
@ensure_naive_first_arg
def _datepart_const_impl(date_ctx, part_ctx, firstday_ctx):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
@ensure_naive_first_arg
def _datepart_nonconst_impl(date_ctx, part_ctx, firstday_ctx):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    firstday: str = un_literal(firstday_ctx.expression)
    return (
        n.case(part_ctx)
        .whens(
...
def norm_datetrunc_unit(unit):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
class FuncDayofweek(SpecificDatepartFunc):
    ...
    @classmethod
    def _norm_fd(cls, firstday):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def dow_firstday_shift(base_1_dow, firstday_expr):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
    """
