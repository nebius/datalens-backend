...
class FuncDbCastBase(TypeConvFunction):
    ...
    def generate_cast_type(
        ...
        def _raise_type_mismath(_arg_num: int):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        ...
        if type_spec.nested_sa_type is not None:
            cast_to_type = type_spec.sa_type(type_spec.nested_sa_type(*unwrapped_native_type_args))  # type: ignore  # 2024-01-22 # TODO: Too many arguments for "TypeEngine"  [call-arg]
        else:
