...
class ValueVariant(Generic[_VARIANT_OF_TV]):
    ...
    def clone(self: _VARIANT_TV, **kwargs) -> _VARIANT_TV:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        copy_kwargs = dict(
    ...
    def match(self, dialect) -> bool:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
...
class FuncTranslationImplementationBase(abc.ABC):
    ...
    def clone(self: _TRANS_IMPL_TV, **kwargs: Any) -> _TRANS_IMPL_TV:
        return attr.evolve(**kwargs)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "evolve" has incompatible type "dict[str, Any]"; expected an attrs class  [misc]
    ...
    def translate(
        ...
        *raw_args: TranslationCtx,
        ...
        if self.translation_order_by is not None:
            order_by_part = self._await_conversion_to_sa(  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "ClauseElement", variable has type "ClauseList | None")  [assignment]
...
class TranslationVariant(ValueVariant[FuncTranslationImplementationBase]):
    ...
    def __repr__(self):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
        _c0 = "\x1b[0m"
        _c1 = "\x1b[038;5;118m"
        return "<{}({})>{}".format(
    ...
    def translate(  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        self,
        *args,
        translator_cb: TranslateCallback,
        partition_by: Optional[ClauseList] = None,
...
class MultiVariantTranslation(NodeTranslation):
    ...
    @classmethod
    def _get_return_type_info(cls, args):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
class SingleVariantTranslationBase(MultiVariantTranslation):
    ...
    def _translate_main(cls, *args):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
class SingleVariantFullOverrideTranslationBase(SingleVariantTranslationBase):
    ...
    @classmethod
    def _translate_all(cls, *args, env=None) -> PartialTranslationResult:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        """Main overridable method"""
        raise NotImplementedError

    @classmethod
    def _translate_main(cls, *args, **kwargs):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
        raise Exception(
            "SingleVariantFullOverrideTranslation._translate_main dummy method was called",
            dict(cls=cls, args=args, kwargs=kwargs),
        )

    def translate(self, env, args) -> TranslationResult:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
