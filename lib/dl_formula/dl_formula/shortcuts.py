...
def _require_type(expected_type: Union[type, Tuple[Union[type, nodes.Array], ...], nodes.Array]):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    def decorator(func):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
        @wraps(func)
        def wrapper(self, value):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
def _norm(value) -> nodes.FormulaItem:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
...
class NodeShortcut:
    ...
    def lit(self, value) -> Union[nodes.BaseLiteral, nodes.Null]:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    ...
    class FuncShortcut:
        ...
        def __getattr__(self, name: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
            return self._make_func(name)

        def __call__(self, name: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
            return self._make_func(name)

        def _make_func(self, name: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
            def wrapper(
    ...
    class WhenProxy:
        def __init__(self, val):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
            self._val = val

        def then(self, expr) -> nodes.WhenPart:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
            return nodes.WhenPart.make(val=_norm(self._val), expr=_norm(expr))

    def when(self, val) -> "NodeShortcut.WhenProxy":  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        return self.WhenProxy(val)

    class CaseProxy:
        def __init__(self, case_expr):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
            self._case_expr = case_expr
            self._when_list = []

        def whens(self, *when_list) -> "NodeShortcut.CaseProxy":  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
            self._when_list += when_list or []
            return self

        def else_(self, expr) -> nodes.CaseBlock:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
            return nodes.CaseBlock.make(
                case_expr=_norm(self._case_expr), when_list=self._when_list, else_expr=_norm(expr)
            )

    def case(self, expr) -> "NodeShortcut.CaseProxy":  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        """
        Usage:
        TODO
        """
    ...
    class IfPartProxy:
        def __init__(self, cond):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
            self._cond = cond
            self._expr = None

        def then(self, expr) -> "NodeShortcut.IfPartProxy":  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
            self._expr = expr
            return self

        def else_(self, expr) -> nodes.IfBlock:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
            return n.IfBlockProxy([self]).else_(expr)

    def elseif(self, cond) -> "NodeShortcut.IfPartProxy":  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    ...
    def if_(self, *exprs) -> Union["NodeShortcut.IfBlockProxy", "NodeShortcut.IfPartProxy"]:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
        """
        Usage:
        TODO
        """
    ...
    def not_(  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        self,
        expr: nodes.FormulaItem,
        meta: Optional[nodes.NodeMeta] = None,
    ):
