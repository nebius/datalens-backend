...
class DLRequestBase:
    ...
    def _set_attr_once(self, name, value) -> None:  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation for one or more arguments  [no-untyped-def]
    ...
    def get_single_header(self, header, required=False):  # type: ignore  # TODO: fix  # noqa
        ...
        return header_value_list[0]  # type: ignore  # 2024-01-22 # TODO: Tuple index out of range  [misc]
