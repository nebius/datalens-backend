...
def get_token_from_authorization_header(secret_header_value, token_type):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
