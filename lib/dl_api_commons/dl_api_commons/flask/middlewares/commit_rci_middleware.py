...
class ReqCtxInfoMiddleware:
    ...
    plain_headers: Tuple[str, ...] = attr.ib(  # type: ignore  # 2024-01-22 # TODO: Need type annotation for "plain_headers"  [var-annotated]
        default=(),
    ...
    secret_headers: Tuple[str, ...] = attr.ib(  # type: ignore  # 2024-01-22 # TODO: Need type annotation for "secret_headers"  [var-annotated]
        default=(),
        converter=lambda extra: append_extra_headers_and_normalize(  # type: ignore
