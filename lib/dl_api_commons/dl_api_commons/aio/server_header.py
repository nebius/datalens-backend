...
class ServerHeader:
    ...
    def add_signal_handlers(self, app: web.Application):  # type: ignore  # TODO: fix
        app.on_response_prepare.append(self.on_response_prepare)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "append" of "MutableSequence" has incompatible type "Callable[[Request, Response], Coroutine[Any, Any, Any]]"; expected "Callable[[Request, StreamResponse], Awaitable[None]]"  [arg-type]
