...
class DefaultSchema(BaseSchema, Generic[_TARGET_OBJECT_TV]):
    TARGET_CLS: ClassVar[Type[_TARGET_OBJECT_TV]]  # type: ignore  # 2024-01-22 # TODO: ClassVar cannot contain type variables  [misc]
...
class DefaultValidateSchema(DefaultSchema[_TARGET_OBJECT_TV], Generic[_TARGET_OBJECT_TV]):
    ...
    def post_load(self, data: Dict[str, Any], **_: Any) -> _TARGET_OBJECT_TV:
        ...
        as_dict = attr.asdict(obj, recurse=False)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "asdict" has incompatible type "_TARGET_OBJECT_TV"; expected "AttrsInstance"  [arg-type]
