...
from dl_formula_ref.reference import (
    FuncReference,
    load_func_reference_from_registry,
)
from dl_formula_ref.registry.dialect_extractor import COMPENG_SUPPORT
...
try:
    ...
    class DataPreparer:  # type: ignore
        def __init__(self, *args, **kwargs):  # type: ignore  # 2024-01-22 # TODO: Function is missing a type annotation  [no-untyped-def]
...
class ReferenceDocGenerator:
    ...
    def generate_doc_func(self, outdir: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
    ...
    def generate_doc_list_all(self, context_path: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        doc_config = self._gen_config.func_doc_configs[FuncDocConfigVersion.overview_shortcut]
        raw_funcs = self._func_ref.as_list()
        rend_funcs = self._render_funcs(raw_funcs=raw_funcs, doc_config=doc_config)
    ...
    def generate_doc_list_category(self, category: str, context_path: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        doc_config = self._gen_config.func_doc_configs[FuncDocConfigVersion.overview_shortcut]
    ...
    def generate_doc_full_dir(self, outdir: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
        raw_funcs = self._func_ref.as_list()
        funcs_by_category = self._group_raw_funcs_by_category(raw_funcs=raw_funcs)
