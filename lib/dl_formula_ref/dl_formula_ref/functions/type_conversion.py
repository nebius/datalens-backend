...
class DbCastWhiteListAliasedResourceRegistry(AliasedResourceRegistryBase):
    def get_resources(self) -> MutableMapping[str, AliasedResource]:
        ...
        return resources  # type: ignore  # 2024-01-22 # TODO: Incompatible return value type (got "dict[str, AliasedTableResource]", expected "MutableMapping[str, AliasedResource]")  [return-value]
