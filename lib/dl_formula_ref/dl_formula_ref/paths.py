...
class FuncPathTemplate(NamedTuple):
    ...
    def format(self, category_name: str, func_name: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
...
class CatPathTemplate(NamedTuple):
    ...
    def format(self, category_name: str):  # type: ignore  # 2024-01-22 # TODO: Function is missing a return type annotation  [no-untyped-def]
