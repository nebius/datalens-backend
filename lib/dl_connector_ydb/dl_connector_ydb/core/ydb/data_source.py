...
class YDBTableDataSource(YDBDataSourceMixin, StandardSQLDataSource):
    ...
    def get_sql_source(self, alias: Optional[str] = None) -> ClauseElement:
        ...
        assert not self.db_name or self.db_name == self.connection.db_name  # type: ignore  # 2024-01-22 # TODO: "ConnectionBase" has no attribute "db_name"; maybe "dir_name"?  [attr-defined]
