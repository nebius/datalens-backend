...
class YQLEngineWrapper(EngineWrapperBase):
    ...
    def _get_table_path(self, table: sa.Table) -> str:
        return os.path.join(self.engine.url.query["database"], table.name)  # type: ignore  # 2024-01-22 # TODO: Argument 1 to "join" has incompatible type "str | tuple[str, ...]"; expected "str"  [arg-type]
