...
class GreenplumApiBackendDefinition(PostgreSQLApiBackendDefinition):
    core_backend_definition = GreenplumCoreBackendDefinition  # type: ignore  # 2024-01-22 # TODO: Incompatible types in assignment (expression has type "type[GreenplumCoreBackendDefinition]", base class "PostgreSQLApiBackendDefinition" defined the type as "type[PostgreSQLCoreBackendDefinition]")  [assignment]
